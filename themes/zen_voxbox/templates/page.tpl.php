...
<body class="<?php print $classes; ?>">
  ...
  <div id="page-wrapper"><div id="page" class="container">
    ...
    <div id="footer" class="row"><div class="span12">
      <?php if ($footer_message): ?>
        <div id="footer-message"><?php print $footer_message; ?></div>
      <?php endif; ?>
      
        <a href="http://drupal.org/" name="Drupal"><img src="<?php print path_to_theme(); ?>/images/powered-by-drupal.png" alt="<?php print t('Powered by Drupal'); ?>" /></a>
        <a href="http://civic.mit.edu/" name="MIT Center for Civic Media"><img src="<?php print path_to_theme(); ?>/images/powered-by-c4cm.gif" alt="<?php print t('Powered by the MIT Center for Civic Media'); ?>" /></a>
