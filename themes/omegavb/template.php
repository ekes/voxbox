...
if (theme_get_setting('omegavb_fixed')) {
 ...
 */
function omegavb_theme(&$existing, $type, $theme, $path) {
...
function omegavb_preprocess(&$vars, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function omegavb_preprocess_page(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function omegavb_preprocess_comment(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function omegavb_preprocess_block(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
